...
square[33] = new Square("红十字", "购买后每次到达红十字便可以得到一张免费出狱卡，若已有该卡则会自动兑换成$50",
	"#FFFFFF", 150, 1);//1
...
square[36] = new Square("香港", "所以房产租金连续三回合提升10%", "#FFFFFF", 0, 0);//0
...
square[48] = new Square("约旦佩特拉城", "$400", "#00f08F", 400, 11, 120, 300, 700, 1600, 1900, 2200);//11
