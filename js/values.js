...
square[33] = new Square("红十字", "购买后每次到达红十字便可以得到一张免费出狱卡", "#FFFFFF", 150, 1);//1
...
square[38] = new Square("白宫", "拥有者可以向其他所有用户征收其资产的10%", "#FFFFFF", 0, 1);//1
...
communityChestCards[0] = new Card("出狱卡，这张卡将会被保存到使用或者交易出去.", function() { });
...
chanceCards[5] = new Card("前进到最近的一个公司. 如果无主, 您可以花费$50购得. 如果有主, 支付给主人$150.", function() { });
